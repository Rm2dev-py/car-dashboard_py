    ...
    <WebSocketProvider>
      <DragProvider>
        <div className="relative w-screen h-screen overflow-hidden bg-black text-white">
          ...
          {/* Nav minimaliste - ne bloque pas le drag */}
          <nav className="absolute left-4 top-4 z-50 flex gap-3 px-3 py-2 rounded-lg bg-neutral-900/70 border border-neutral-700/60 backdrop-blur pointer-events-none">
