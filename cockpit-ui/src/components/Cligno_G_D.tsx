...
type Props = {
  ...
  blinkMs?: number; // période de clignotement
};
...
export default function Cligno_G_D({
  ...
  const wsData = useWS();
  const isActive =
    wsData?.voyant_cligno_g === 1 || wsData?.voyant_cligno_g === true;
  ...
  return (
    ...
    >
      <mask
        ...
        fill="black"
      >
        <rect fill="#565656" x="717.457" y="4.85025" width="46.25" height="39.72" />
        <path
