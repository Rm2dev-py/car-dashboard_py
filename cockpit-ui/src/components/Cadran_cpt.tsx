...
// 🧭 Composant statique pour afficher un grand SVG manipulable
...
export default function VueGenerale() {
  const [position, setPosition] = useState(() => {
    const saved = localStorage.getItem("vue_generale_position");
  ...
  const handleStart = (e: React.MouseEvent | React.TouchEvent) => {
    ...
    handleMove(e as any); // ⬅️ force le snap dès le début
  };
  ...
  useEffect(() => {
    localStorage.setItem("vue_generale_position", JSON.stringify(position));
  }, [position]);
